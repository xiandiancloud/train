...
<!-- end dummy segment.io -->
  ...
  <body class="is-signedin course users view-team hide-wip lang_zh-cn js">
...
<div class="wrapper-mast wrapper">
  <header class="mast has-actions has-subtitle">
    ...
    <nav class="nav-actions">
      ...
      <ul>
        <li class="nav-item">
          <a href="#" class="button new-button create-user-button"><i class="icon-plus"></i> 新的团队成员</a>
        </li>
      </ul>
    </nav>
  </header>
  ...
  <section class="content">
    <article class="content-primary" role="main">
      <div class="wrapper-create-element animate wrapper-create-user">
        <form class="create-user" id="create-user-form" name="create-user-form">
          <div class="wrapper-form">
            <h3 class="title">向您的课程团队中添加一个用户</h3>

            <fieldset class="form-fields">
              <legend class="sr">新团队成员信息</legend>

                <ol class="list-input">
                  <li class="field text required create-user-email">
                    <label for="user-email-input">用户邮箱地址</label>
                    <input id="user-email-input" name="user-email" type="text" placeholder="例如：jane.doe@gmail.com" value="">
                    <span class="tip tip-stacked">请提供您想要添加的课程教员的邮箱地址</span>
                  </li>
                </ol>
            </fieldset>
          </div>
          ...
          <div class="actions">
            <button class="action action-primary" type="submit">添加用户</button>
      ...
      <ol class="user-list">
        ...
        <li class="user-item" data-email="staff@example.com" data-url="/course_team/cetc/CS201/2014_T1/staff@example.com">

        
          <span class="wrapper-ui-badge">
            <span class="flag flag-role flag-role-admin is-hanging">
              <span class="label sr">当前角色：</span>
              <span class="value">
                管理员
                    <span class="msg-you">您！</span>
              </span>
            </span>
          </span>
          ...
          <div class="item-metadata">
            <h3 class="user-name">
              ...
              <span class="user-email">
                <a class="action action-email" href="mailto:staff@example.com" title="向staff@example.com发送一封邮件信息">staff@example.com</a>
              </span>
            </h3>
          </div>
          ...
          <ul class="item-actions user-actions">
            <li class="action action-role">
                <span class="admin-role notoggleforyou">提升另一名成员为管理员，解除您自己的管理权限</span>
            </li>
            <li class="action action-delete is-disabled">
                <a href="#" class="delete remove-user action-icon" data-id="staff@example.com"><i class="icon-trash"></i><span class="sr">删除用户，staff</span></a>
            </li>
          </ul>
      ...
      <div class="notice notice-incontext notice-create has-actions">
        <div class="msg">
          <h3 class="title">向该课程添加团队成员</h3>
          <div class="copy">
            <p>添加团队成员以共同完成课程创作。用户必须注册了Studio并且拥有一个已激活账户。</p>
          </div>
        </div>

        <ul class="list-actions">
          <li class="action-item">
            <a href="#" class="action action-primary button new-button create-user-button"><i class="icon-plus icon-inline"></i> 添加一个团队成员</a>
          </li>
        </ul>
      </div>
    </article>
    ...
    <aside class="content-supplementary" role="complimentary">
      <div class="bit">
        <h3 class="title-3">课程团队角色</h3>
        <p>课程团队成员或教员都是课程共同作者。他们有权编写及修改所有课程内容。</p>
        <p>管理员是课程团队成员中可以添加和移除其它课程团队成员的用户。</p>      
      </div>

      <div class="bit">
        <h3 class="title-3">移交所有权</h3>
        <p>每门课程必须有一名管理员。如果您当前是管理员，且期望移交管理员身份，您可以赋予其他用户管理员权限，并请求他们将你从课程团队列表中删除。</p>
      </div>
    </aside>
  </section>
</div>
...
require(["jquery", "underscore", "gettext", "js/views/feedback_prompt"],
  ...
  var staffEmails = ["staff@example.com"];
  var tplUserURL = "/course_team/cetc/CS201/2014_T1/@@EMAIL@@"
...
<table>
	...
	<tbody>
			...
			<tr class="djDebugOdd">
				...
				<td>153 voluntary, 28 involuntary</td>
			</tr>
...
<table>
 ...
 u'OPTIONS': {u'db': u'edxapp',
			...
			<tr class="djDebugOdd">
				...
				<td><code>{'logger': {'ENGINE': 'eventtracking.backends.logger.LoggerBackend',
            'OPTIONS': {'max_event_size': 50000, 'name': 'tracking'}}}</code></td>
			</tr>
			...
			<tr class="djDebugEven">
				...
				<td><code>'Django/1.4.12 (https://www.djangoproject.com)'</code></td>
			</tr>
 ...
 'pipeline.finders.PipelineFinder')</code></td>
			...
			<tr class="djDebugOdd">
				<td>DATABASES</td>
				<td><code>{u'default': {u'ENGINE': u'django.db.backends.mysql',
              u'HOST': u'localhost',
              u'NAME': u'edxapp',
              'OPTIONS': {},
              u'PASSWORD': u'********************',
 ...
 'django.core.files.uploadhandler.TemporaryFileUploadHandler')</code></td>
			...
			<tr class="djDebugEven">
				<td>PIPELINE_JS</td>
				<td><code>{'module-js': {'output_filename': 'js/cms-modules.js',
               'source_filenames': [u'xmodule/descriptors/js/000-38c1026a572b76f052cb032657dc6d93.js',
			...
			<tr class="djDebugEven">
				<td>CACHES</td>
				<td><code>{u'celery': {u'BACKEND': u'django.core.cache.backends.memcached.MemcachedCache',
             u'KEY_FUNCTION': u'********************',
             u'KEY_PREFIX': u'********************',
             u'LOCATION': [u'localhost:11211'],
             u'TIMEOUT': u'7200'},
 ...
 u'staticfiles': {u'BACKEND': u'django.core.cache.backends.memcached.MemcachedCache',
                  u'KEY_FUNCTION': u'********************',
                  u'KEY_PREFIX': u'********************',
                  u'LOCATION': [u'localhost:11211']}}</code></td>
			</tr>
			...
			<tr class="djDebugEven">
				...
				<td><code>{'basic_auth': None,
 'django_auth': {'password': 'local', 'username': 'local'},
 'url': 'http://localhost:8888'}</code></td>
			</tr>
 ...
 u'CERTIFICATES_ENABLED': True,
 u'ENABLE_DISCUSSION_SERVICE': True,
 u'ENABLE_INSTRUCTOR_ANALYTICS': True,
 u'ENABLE_S3_GRADE_DOWNLOADS': True,
 u'PREVIEW_LMS_BASE': u'',
 u'SUBDOMAIN_BRANDING': False,
 u'SUBDOMAIN_COURSE_LISTINGS': False,
 ...
 'ENABLE_GROUP_CONFIGURATIONS': None,
 u'ENABLE_INSTRUCTOR_ANALYTICS': True,
 ...
 u'PREVIEW_LMS_BASE': 'preview.localhost:8000',
 'SEGMENT_IO': False,
 ...
 'openassessment.xblock')</code></td>
			...
			<tr class="djDebugOdd">
             ...
             'OPTIONS': {'mappings': {},
                         'stores': [{u'DOC_STORE_CONFIG': {u'collection': u'modulestore',
                                                           u'db': u'edxapp',
                                                           u'host': [u'localhost'],
                                                           u'password': u'password',
                                                           u'port': 27017,
                                     ...
                                     'NAME': u'default',
                                     u'OPTIONS': {u'collection': u'modulestore',
                                                  u'db': u'edxapp',
                                    ...
                                    {u'DOC_STORE_CONFIG': {u'collection': u'modulestore',
                                                           ...
                                                           u'port': 27017,
                                                           u'user': u'edxapp'},
                                     u'ENGINE': 'xmodule.modulestore.mongo.draft.DraftModuleStore',
                                     'NAME': u'direct',
                                     u'OPTIONS': {u'collection': u'modulestore',
                                                  u'db': u'edxapp',
                                                  u'default_class': u'xmodule.hidden_module.HiddenDescriptor',
                                    ...
                                    {u'DOC_STORE_CONFIG': {u'collection': u'modulestore',
                                                           ...
                                                           u'port': 27017,
                                                           u'user': u'edxapp'},
                                     u'ENGINE': 'xmodule.modulestore.split_mongo.split_draft.DraftVersioningModuleStore',
                                     'NAME': 'split',
                                     u'OPTIONS': {u'collection': u'modulestore',
                                                  u'db': u'edxapp',
                                                  u'default_class': u'xmodule.hidden_module.HiddenDescriptor',
 ...
 'style-app-extend1': {'output_filename': 'css/cms-style-app-extend1.css',
                       'source_filenames': ['sass/style-app-extend1.css']},
 'style-vendor': {'output_filename': 'css/cms-style-vendor.css',
                  'source_filenames': ['css/vendor/normalize.css',
 ...
 'style-vendor-tinymce-content': {'output_filename': 'css/cms-style-vendor-tinymce-content.css',
 ...
 'formatters': {'raw': {'format': '%(message)s'},
                ...
                'syslog_format': {'format': '[service_variant=cms][%(name)s][env:sandbox] %(levelname)s [precise64  %(process)d] [%(filename)s:%(lineno)d] - %(message)s'}},
 'handlers': {'console': {'class': 'logging.StreamHandler',
              ...
              'mail_admins': {'class': 'django.utils.log.AdminEmailHandler',
                              ...
                              'level': 'ERROR'},
              'newrelic': {'class': 'lms.lib.newrelic_logging.NewRelicHandler',
                           'formatter': 'raw',
                           'level': 'ERROR'},
              'tracking': {'address': '/dev/log',
                           'class': 'logging.handlers.SysLogHandler',
                           'facility': 17,
                           'formatter': 'raw',
                           'level': 'DEBUG'}},
...
<table>
	...
	<tbody>
			...
			<tr class="djDebugOdd">
				<td>HTTP_REFERER</td>
				<td>http://192.168.1.112:8001/settings/details/cetc/CS201/2014_T1</td>
			</tr>
			...
			<tr class="djDebugOdd">
				...
				<td>WSGIServer/0.1 Python/2.7.3</td>
			</tr>
...
<table>
	...
	<tbody>
		<tr>
			<td>contentstore.views.user.course_team_handler</td>
			<td>None</td>
			<td>
	...
	<table>
		...
		<tbody>
				...
				<tr class="djDebugEven">
					...
					<td>ratelimitbackend.backends.RateLimitModelBackend</td>
				</tr>
			
				<tr class="djDebugOdd">
					<td>_session_expiry</td>
					<td>0</td>
				</tr>
...
<div class="clearfix">
	<ul class="stats">
			...
			<li>
				<strong class="label"><span style="background-color: rgb(256, 0, 0)" class="color">&nbsp;</span> default</strong>
				<span class="info">16.93 ms (40 queries)</span>
			</li>
	...
	<table>
		<thead>
			<tr>
				...
				<th class="actions">动作</th>
			</tr>
		</thead>
		<tbody>
			
				<tr class="djDebugHoverable djDebugOdd" id="sqlMain_1">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="1" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>INNER JOIN</strong> `student_courseaccessrole` <strong>ON</strong> (`auth_user`.`id` = `student_courseaccessrole`.`user_id`) <strong>WHERE</strong> (`student_courseaccessrole`.`course_id` = 'cetc/CS201/2014_T1'  <strong>AND</strong> `student_courseaccessrole`.`role` = 'staff'  <strong>AND</strong> `student_courseaccessrole`.`org` = 'cetc' )</div>
						</div>
					</td>
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:0.000000%;"><strong style="width:3.236093%;">3.2360930672%</strong></div></div>
					</td>
					<td class="time">
						0.55
					</td>
					<td class="actions">
							...
							<a class="remoteCall" href="/__debug__/sql_select/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20INNER%20JOIN%20%60student_courseaccessrole%60%20ON%20%28%60auth_user%60.%60id%60%20%3D%20%60student_courseaccessrole%60.%60user_id%60%29%20WHERE%20%28%60student_courseaccessrole%60.%60course_id%60%20%3D%20%25s%20%20AND%20%60student_courseaccessrole%60.%60role%60%20%3D%20%25s%20%20AND%20%60student_courseaccessrole%60.%60org%60%20%3D%20%25s%20%29&amp;params=%5B%22cetc/CS201/2014_T1%22%2C%20%22staff%22%2C%20%22cetc%22%5D&amp;duration=0.55&amp;hash=5810c57037357c0dca9e744f629914907569fe68&amp;alias=default">Sel</a>
							<a class="remoteCall" href="/__debug__/sql_explain/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20INNER%20JOIN%20%60student_courseaccessrole%60%20ON%20%28%60auth_user%60.%60id%60%20%3D%20%60student_courseaccessrole%60.%60user_id%60%29%20WHERE%20%28%60student_courseaccessrole%60.%60course_id%60%20%3D%20%25s%20%20AND%20%60student_courseaccessrole%60.%60role%60%20%3D%20%25s%20%20AND%20%60student_courseaccessrole%60.%60org%60%20%3D%20%25s%20%29&amp;params=%5B%22cetc/CS201/2014_T1%22%2C%20%22staff%22%2C%20%22cetc%22%5D&amp;duration=0.55&amp;hash=5810c57037357c0dca9e744f629914907569fe68&amp;alias=default">Expl</a>
					...
					<td colspan="4">
						<div class="djSQLDetailsDiv">
							<p><strong>Connection:</strong> default</p>
								...
								<pre class="stack"><span class="path">/edx/app/edxapp/venvs/edxapp/src/django-staticfiles/staticfiles/</span><span class="file">handlers.py</span> in <span class="func">__call__</span>(<span class="lineno">66</span>)
  <span class="code">return self.application(environ, start_response)</span>
<span class="path">/edx/app/edxapp/venvs/edxapp/local/lib/python2.7/site-packages/django/contrib/auth/</span><span class="file">decorators.py</span> in <span class="func">_wrapped_view</span>(<span class="lineno">20</span>)
  <span class="code">return view_func(request, *args, **kwargs)</span>
<span class="path">/edx/app/edxapp/edx-platform/cms/djangoapps/contentstore/views/</span><span class="file">user.py</span> in <span class="func">course_team_handler</span>(<span class="lineno">59</span>)
  <span class="code">return _manage_users(request, course_key)</span>
<span class="path">/edx/app/edxapp/edx-platform/cms/djangoapps/contentstore/views/</span><span class="file">user.py</span> in <span class="func">_manage_users</span>(<span class="lineno">75</span>)
  <span class="code">staff = set(CourseStaffRole(course_key).users_with_role()).union(instructors)</span></pre>
				...
				<tr class="djDebugHoverable djDebugEven" id="sqlMain_2">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="2" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>INNER JOIN</strong> `student_courseaccessrole` <strong>ON</strong> (`auth_user`.`id` = `student_courseaccessrole`.`user_id`) <strong>WHERE</strong> (`student_courseaccessrole`.`course_id` = 'cetc/CS201/2014_T1'  <strong>AND</strong> `student_courseaccessrole`.`role` = 'instructor'  <strong>AND</strong> `student_courseaccessrole`.`org` = 'cetc' )</div>
						</div>
					</td>
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:3.236093%;"><strong style="width:8.214329%;">7.94850596433%</strong></div></div>
					</td>
					<td class="time">
						1.35
					</td>
					<td class="actions">
							...
							<a class="remoteCall" href="/__debug__/sql_select/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20INNER%20JOIN%20%60student_courseaccessrole%60%20ON%20%28%60auth_user%60.%60id%60%20%3D%20%60student_courseaccessrole%60.%60user_id%60%29%20WHERE%20%28%60student_courseaccessrole%60.%60course_id%60%20%3D%20%25s%20%20AND%20%60student_courseaccessrole%60.%60role%60%20%3D%20%25s%20%20AND%20%60student_courseaccessrole%60.%60org%60%20%3D%20%25s%20%29&amp;params=%5B%22cetc/CS201/2014_T1%22%2C%20%22instructor%22%2C%20%22cetc%22%5D&amp;duration=1.35&amp;hash=da5a39d3a65f6402c7061cf7ce8ab4f22617ad3d&amp;alias=default">Sel</a>
							<a class="remoteCall" href="/__debug__/sql_explain/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20INNER%20JOIN%20%60student_courseaccessrole%60%20ON%20%28%60auth_user%60.%60id%60%20%3D%20%60student_courseaccessrole%60.%60user_id%60%29%20WHERE%20%28%60student_courseaccessrole%60.%60course_id%60%20%3D%20%25s%20%20AND%20%60student_courseaccessrole%60.%60role%60%20%3D%20%25s%20%20AND%20%60student_courseaccessrole%60.%60org%60%20%3D%20%25s%20%29&amp;params=%5B%22cetc/CS201/2014_T1%22%2C%20%22instructor%22%2C%20%22cetc%22%5D&amp;duration=1.35&amp;hash=da5a39d3a65f6402c7061cf7ce8ab4f22617ad3d&amp;alias=default">Expl</a>
...
<span class="path">/edx/app/edxapp/edx-platform/cms/djangoapps/contentstore/views/</span><span class="file">user.py</span> in <span class="func">_manage_users</span>(<span class="lineno">75</span>)
  <span class="code">staff = set(CourseStaffRole(course_key).users_with_role()).union(instructors)</span></pre>
				...
				<tr class="djDebugHoverable djDebugOdd" id="sqlMain_3">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="3" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`student_courseaccessrole`.`id`, `student_courseaccessrole`.`user_id`, `student_courseaccessrole`.`org`, `student_courseaccessrole`.`course_id`, `student_courseaccessrole`.`role`</a> <strong>FROM</strong> `student_courseaccessrole` <strong>WHERE</strong> `student_courseaccessrole`.`user_id` = 4</div>
						</div>
					</td>
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:11.184599%;"><strong style="width:4.135638%;">3.67308373686%</strong></div></div>
					</td>
					<td class="time">
						0.62
					</td>
					<td class="actions">
							...
							<a class="remoteCall" href="/__debug__/sql_select/?sql=SELECT%20%60student_courseaccessrole%60.%60id%60%2C%20%60student_courseaccessrole%60.%60user_id%60%2C%20%60student_courseaccessrole%60.%60org%60%2C%20%60student_courseaccessrole%60.%60course_id%60%2C%20%60student_courseaccessrole%60.%60role%60%20FROM%20%60student_courseaccessrole%60%20WHERE%20%60student_courseaccessrole%60.%60user_id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.62&amp;hash=332f18e0fc55d1acf4ae86dacdb0f47a7b9bb496&amp;alias=default">Sel</a>
							<a class="remoteCall" href="/__debug__/sql_explain/?sql=SELECT%20%60student_courseaccessrole%60.%60id%60%2C%20%60student_courseaccessrole%60.%60user_id%60%2C%20%60student_courseaccessrole%60.%60org%60%2C%20%60student_courseaccessrole%60.%60course_id%60%2C%20%60student_courseaccessrole%60.%60role%60%20FROM%20%60student_courseaccessrole%60%20WHERE%20%60student_courseaccessrole%60.%60user_id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.62&amp;hash=332f18e0fc55d1acf4ae86dacdb0f47a7b9bb496&amp;alias=default">Expl</a>
...
<span class="path">/edx/app/edxapp/edx-platform/cms/djangoapps/contentstore/views/</span><span class="file">user.py</span> in <span class="func">course_team_handler</span>(<span class="lineno">59</span>)
  <span class="code">return _manage_users(request, course_key)</span>
<span class="path">/edx/app/edxapp/edx-platform/cms/djangoapps/contentstore/views/</span><span class="file">user.py</span> in <span class="func">_manage_users</span>(<span class="lineno">81</span>)
  <span class="code">'allow_actions': has_course_access(request.user, course_key, role=CourseInstructorRole),</span>
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/edxmako/</span><span class="file">shortcuts.py</span> in <span class="func">render_to_response</span>(<span class="lineno">117</span>)
  <span class="code">return HttpResponse(render_to_string(template_name, dictionary, context_instance, namespace), **kwargs)</span>
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/edxmako/</span><span class="file">shortcuts.py</span> in <span class="func">render_to_string</span>(<span class="lineno">104</span>)
  <span class="code">return template.render_unicode(**context_dictionary)</span>
<span class="path">/edx/app/edxapp/venvs/edxapp/local/lib/python2.7/site-packages/mako/</span><span class="file">template.py</span> in <span class="func">render_unicode</span>(<span class="lineno">452</span>)
  <span class="code">as_unicode=True)</span>
<span class="path">/edx/app/edxapp/venvs/edxapp/local/lib/python2.7/site-packages/mako/</span><span class="file">runtime.py</span> in <span class="func">_render</span>(<span class="lineno">807</span>)
  <span class="code">**_kwargs_for_callable(callable_, data))</span>
<span class="path">/edx/app/edxapp/venvs/edxapp/local/lib/python2.7/site-packages/mako/</span><span class="file">runtime.py</span> in <span class="func">_render_context</span>(<span class="lineno">839</span>)
  <span class="code">_exec_template(inherit, lclcontext, args=args, kwargs=kwargs)</span>
<span class="path">/edx/app/edxapp/venvs/edxapp/local/lib/python2.7/site-packages/mako/</span><span class="file">runtime.py</span> in <span class="func">_exec_template</span>(<span class="lineno">865</span>)
  <span class="code">callable_(context, *args, **kwargs)</span>
<span class="path">/tmp/mako_cms/</span><span class="file">base.html.py</span> in <span class="func">render_body</span>(<span class="lineno">237</span>)
  <span class="code">context['self'].content(**pageargs)</span>
<span class="path">/tmp/mako_cms/</span><span class="file">manage_users.html.py</span> in <span class="func">render_content</span>(<span class="lineno">177</span>)
  <span class="code">is_instuctor = CourseInstructorRole(context_course.id).has_user(user)</span>
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">roles.py</span> in <span class="func">has_user</span>(<span class="lineno">120</span>)
  <span class="code">user._roles = RoleCache(user)</span>
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">roles.py</span> in <span class="func">__init__</span>(<span class="lineno">19</span>)
  <span class="code">CourseAccessRole.objects.filter(user=user).all()</span></pre>
				...
				<tr class="djDebugHoverable djDebugEven" id="sqlMain_4">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="4" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
						</div>
					</td>
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:14.857682%;"><strong style="width:2.580108%;">2.19676390693%</strong></div></div>
					</td>
					<td class="time">
						0.37
					</td>
					<td class="actions">
							...
							<a class="remoteCall" href="/__debug__/sql_select/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.37&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Sel</a>
							<a class="remoteCall" href="/__debug__/sql_explain/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.37&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Expl</a>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">roles.py</span> in <span class="func">has_user</span>(<span class="lineno">120</span>)
  <span class="code">user._roles = RoleCache(user)</span>
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">roles.py</span> in <span class="func">__init__</span>(<span class="lineno">19</span>)
  <span class="code">CourseAccessRole.objects.filter(user=user).all()</span>
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">__hash__</span>(<span class="lineno">1071</span>)
  <span class="code">return hash(self._key)</span>
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugOdd" id="sqlMain_5">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="5" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:17.054446%;"><strong style="width:3.994019%;">3.31286169836%</strong></div></div>
					</td>
					<td class="time">
						0.56
					</td>
					<td class="actions">
							...
							<a class="remoteCall" href="/__debug__/sql_select/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.56&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Sel</a>
							<a class="remoteCall" href="/__debug__/sql_explain/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.56&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Expl</a>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugEven" id="sqlMain_6">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="6" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:20.367308%;"><strong style="width:3.908045%;">3.11208220149%</strong></div></div>
					</td>
					<td class="time">
						0.53
					</td>
					<td class="actions">
							...
							<a class="remoteCall" href="/__debug__/sql_select/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.53&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Sel</a>
							<a class="remoteCall" href="/__debug__/sql_explain/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.53&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Expl</a>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugOdd" id="sqlMain_7">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="7" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:23.479390%;"><strong style="width:2.299737%;">1.75977323727%</strong></div></div>
					</td>
					<td class="time">
						0.30
					</td>
					<td class="actions">
							...
							<a class="remoteCall" href="/__debug__/sql_select/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.30&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Sel</a>
							<a class="remoteCall" href="/__debug__/sql_explain/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.30&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Expl</a>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugEven" id="sqlMain_8">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="8" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:25.239163%;"><strong style="width:3.333333%;">2.49202787292%</strong></div></div>
					</td>
					<td class="time">
						0.42
					</td>
					<td class="actions">
							...
							<a class="remoteCall" href="/__debug__/sql_select/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.42&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Sel</a>
							<a class="remoteCall" href="/__debug__/sql_explain/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.42&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Expl</a>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugOdd" id="sqlMain_9">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="9" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:27.731191%;"><strong style="width:2.606635%;">1.88378410299%</strong></div></div>
					</td>
					<td class="time">
						0.32
					</td>
					<td class="actions">
							...
							<a class="remoteCall" href="/__debug__/sql_select/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.32&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Sel</a>
							<a class="remoteCall" href="/__debug__/sql_explain/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.32&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Expl</a>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugEven" id="sqlMain_10">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="10" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:29.614975%;"><strong style="width:2.886148%;">2.03141608598%</strong></div></div>
					</td>
					<td class="time">
						0.34
					</td>
					<td class="actions">
							...
							<a class="remoteCall" href="/__debug__/sql_select/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.34&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Sel</a>
							<a class="remoteCall" href="/__debug__/sql_explain/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.34&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Expl</a>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugOdd" id="sqlMain_11">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="11" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:31.646391%;"><strong style="width:3.447084%;">2.35620644857%</strong></div></div>
					</td>
					<td class="time">
						0.40
					</td>
					<td class="actions">
							...
							<a class="remoteCall" href="/__debug__/sql_select/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.40&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Sel</a>
							<a class="remoteCall" href="/__debug__/sql_explain/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.40&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Expl</a>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugEven" id="sqlMain_12">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="12" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:34.002598%;"><strong style="width:3.605941%;">2.37982756584%</strong></div></div>
					</td>
					<td class="time">
						0.40
					</td>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugOdd" id="sqlMain_13">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="13" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:36.382425%;"><strong style="width:3.620161%;">2.30305893469%</strong></div></div>
					</td>
					<td class="time">
						0.39
					</td>
					<td class="actions">
							...
							<a class="remoteCall" href="/__debug__/sql_select/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.39&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Sel</a>
							<a class="remoteCall" href="/__debug__/sql_explain/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.39&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Expl</a>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugEven" id="sqlMain_14">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="14" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:38.685484%;"><strong style="width:3.804295%;">2.33258533129%</strong></div></div>
					</td>
					<td class="time">
						0.40
					</td>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugOdd" id="sqlMain_15">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="15" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:41.018070%;"><strong style="width:3.574289%;">2.10818471714%</strong></div></div>
					</td>
					<td class="time">
						0.36
					</td>
					<td class="actions">
							...
							<a class="remoteCall" href="/__debug__/sql_select/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.36&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Sel</a>
							<a class="remoteCall" href="/__debug__/sql_explain/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.36&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Expl</a>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugEven" id="sqlMain_16">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="16" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:43.126254%;"><strong style="width:3.686013%;">2.0963741585%</strong></div></div>
					</td>
					<td class="time">
						0.36
					</td>
				...
				<tr class="djUnselected djDebugHoverable djDebugEven djToggleDetails_16" id="sqlDetails_16">
					<td colspan="2"></td>
					<td colspan="4">
						<div class="djSQLDetailsDiv">
							<p><strong>Connection:</strong> default</p>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugOdd" id="sqlMain_17">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="17" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:45.222629%;"><strong style="width:4.204398%;">2.30305893469%</strong></div></div>
					</td>
					<td class="time">
						0.39
					</td>
				...
				<tr class="djUnselected djDebugHoverable djDebugOdd djToggleDetails_17" id="sqlDetails_17">
					<td colspan="2"></td>
					<td colspan="4">
						<div class="djSQLDetailsDiv">
							<p><strong>Connection:</strong> default</p>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugEven" id="sqlMain_18">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="18" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:47.525687%;"><strong style="width:3.466126%;">1.81882603047%</strong></div></div>
					</td>
					<td class="time">
						0.31
					</td>
					<td class="actions">
							...
							<a class="remoteCall" href="/__debug__/sql_select/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.31&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Sel</a>
							<a class="remoteCall" href="/__debug__/sql_explain/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.31&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Expl</a>
							
						
					
					</td>
				</tr>
				<tr class="djUnselected djDebugHoverable djDebugEven djToggleDetails_18" id="sqlDetails_18">
					<td colspan="2"></td>
					<td colspan="4">
						<div class="djSQLDetailsDiv">
							<p><strong>Connection:</strong> default</p>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugOdd" id="sqlMain_19">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="19" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:49.344513%;"><strong style="width:3.916996%;">1.98417385142%</strong></div></div>
					</td>
					<td class="time">
						0.34
					</td>
				...
				<tr class="djUnselected djDebugHoverable djDebugOdd djToggleDetails_19" id="sqlDetails_19">
					<td colspan="2"></td>
					<td colspan="4">
						<div class="djSQLDetailsDiv">
							<p><strong>Connection:</strong> default</p>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugEven" id="sqlMain_20">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="20" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:51.328687%;"><strong style="width:4.913855%;">2.39163812448%</strong></div></div>
					</td>
					<td class="time">
						0.41
					</td>
					<td class="actions">
							...
							<a class="remoteCall" href="/__debug__/sql_select/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.41&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Sel</a>
							<a class="remoteCall" href="/__debug__/sql_explain/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.41&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Expl</a>
							
						
					
					</td>
				</tr>
				<tr class="djUnselected djDebugHoverable djDebugEven djToggleDetails_20" id="sqlDetails_20">
					<td colspan="2"></td>
					<td colspan="4">
						<div class="djSQLDetailsDiv">
							<p><strong>Connection:</strong> default</p>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugOdd" id="sqlMain_21">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="21" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:53.720325%;"><strong style="width:3.853515%;">1.78339435455%</strong></div></div>
					</td>
					<td class="time">
						0.30
					</td>
				...
				<tr class="djUnselected djDebugHoverable djDebugOdd djToggleDetails_21" id="sqlDetails_21">
					<td colspan="2"></td>
					<td colspan="4">
						<div class="djSQLDetailsDiv">
							<p><strong>Connection:</strong> default</p>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugEven" id="sqlMain_22">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="22" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`student_courseaccessrole`.`id`, `student_courseaccessrole`.`user_id`, `student_courseaccessrole`.`org`, `student_courseaccessrole`.`course_id`, `student_courseaccessrole`.`role`</a> <strong>FROM</strong> `student_courseaccessrole` <strong>WHERE</strong> `student_courseaccessrole`.`user_id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:55.503720%;"><strong style="width:4.445919%;">1.9782685721%</strong></div></div>
					</td>
					<td class="time">
						0.34
					</td>
					<td class="actions">
							...
							<a class="remoteCall" href="/__debug__/sql_select/?sql=SELECT%20%60student_courseaccessrole%60.%60id%60%2C%20%60student_courseaccessrole%60.%60user_id%60%2C%20%60student_courseaccessrole%60.%60org%60%2C%20%60student_courseaccessrole%60.%60course_id%60%2C%20%60student_courseaccessrole%60.%60role%60%20FROM%20%60student_courseaccessrole%60%20WHERE%20%60student_courseaccessrole%60.%60user_id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.34&amp;hash=332f18e0fc55d1acf4ae86dacdb0f47a7b9bb496&amp;alias=default">Sel</a>
							<a class="remoteCall" href="/__debug__/sql_explain/?sql=SELECT%20%60student_courseaccessrole%60.%60id%60%2C%20%60student_courseaccessrole%60.%60user_id%60%2C%20%60student_courseaccessrole%60.%60org%60%2C%20%60student_courseaccessrole%60.%60course_id%60%2C%20%60student_courseaccessrole%60.%60role%60%20FROM%20%60student_courseaccessrole%60%20WHERE%20%60student_courseaccessrole%60.%60user_id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.34&amp;hash=332f18e0fc55d1acf4ae86dacdb0f47a7b9bb496&amp;alias=default">Expl</a>
							
						
					
					</td>
				</tr>
				<tr class="djUnselected djDebugHoverable djDebugEven djToggleDetails_22" id="sqlDetails_22">
					<td colspan="2"></td>
					<td colspan="4">
						<div class="djSQLDetailsDiv">
							<p><strong>Connection:</strong> default</p>
...
<span class="path">/tmp/mako_cms/</span><span class="file">base.html.py</span> in <span class="func">render_body</span>(<span class="lineno">237</span>)
  <span class="code">context['self'].content(**pageargs)</span>
<span class="path">/tmp/mako_cms/</span><span class="file">manage_users.html.py</span> in <span class="func">render_content</span>(<span class="lineno">261</span>)
  <span class="code">user_is_instuctor = CourseInstructorRole(context_course.id).has_user(request.user)</span>
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">roles.py</span> in <span class="func">has_user</span>(<span class="lineno">120</span>)
  <span class="code">user._roles = RoleCache(user)</span>
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">roles.py</span> in <span class="func">__init__</span>(<span class="lineno">19</span>)
  <span class="code">CourseAccessRole.objects.filter(user=user).all()</span></pre>
				...
				<tr class="djDebugHoverable djDebugOdd" id="sqlMain_23">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="23" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:57.481988%;"><strong style="width:6.638888%;">2.82272351482%</strong></div></div>
					</td>
					<td class="time">
						0.48
					</td>
					<td class="actions">
							...
							<a class="remoteCall" href="/__debug__/sql_select/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.48&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Sel</a>
							<a class="remoteCall" href="/__debug__/sql_explain/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.48&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Expl</a>
							
						
					
					</td>
				</tr>
				<tr class="djUnselected djDebugHoverable djDebugOdd djToggleDetails_23" id="sqlDetails_23">
					<td colspan="2"></td>
					<td colspan="4">
						<div class="djSQLDetailsDiv">
							<p><strong>Connection:</strong> default</p>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugEven" id="sqlMain_24">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="24" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:60.304712%;"><strong style="width:7.973817%;">3.16522971537%</strong></div></div>
					</td>
					<td class="time">
						0.54
					</td>
					<td class="actions">
							...
							<a class="remoteCall" href="/__debug__/sql_select/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.54&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Sel</a>
							<a class="remoteCall" href="/__debug__/sql_explain/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.54&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Expl</a>
							
						
					
					</td>
				</tr>
				<tr class="djUnselected djDebugHoverable djDebugEven djToggleDetails_24" id="sqlDetails_24">
					<td colspan="2"></td>
					<td colspan="4">
						<div class="djSQLDetailsDiv">
							<p><strong>Connection:</strong> default</p>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugOdd" id="sqlMain_25">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="25" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:63.469942%;"><strong style="width:6.967345%;">2.5451753868%</strong></div></div>
					</td>
					<td class="time">
						0.43
					</td>
					<td class="actions">
							...
							<a class="remoteCall" href="/__debug__/sql_select/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.43&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Sel</a>
							<a class="remoteCall" href="/__debug__/sql_explain/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.43&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Expl</a>
							
						
					
					</td>
				</tr>
				<tr class="djUnselected djDebugHoverable djDebugOdd djToggleDetails_25" id="sqlDetails_25">
					<td colspan="2"></td>
					<td colspan="4">
						<div class="djSQLDetailsDiv">
							<p><strong>Connection:</strong> default</p>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugEven" id="sqlMain_26">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="26" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:66.015117%;"><strong style="width:7.350130%;">2.49793315224%</strong></div></div>
					</td>
					<td class="time">
						0.42
					</td>
				...
				<tr class="djUnselected djDebugHoverable djDebugEven djToggleDetails_26" id="sqlDetails_26">
					<td colspan="2"></td>
					<td colspan="4">
						<div class="djSQLDetailsDiv">
							<p><strong>Connection:</strong> default</p>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugOdd" id="sqlMain_27">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="27" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:68.513050%;"><strong style="width:6.920480%;">2.17904806897%</strong></div></div>
					</td>
					<td class="time">
						0.37
					</td>
				...
				<tr class="djUnselected djDebugHoverable djDebugOdd djToggleDetails_27" id="sqlDetails_27">
					<td colspan="2"></td>
					<td colspan="4">
						<div class="djSQLDetailsDiv">
							<p><strong>Connection:</strong> default</p>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugEven" id="sqlMain_28">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="28" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:70.692098%;"><strong style="width:7.596211%;">2.22629030353%</strong></div></div>
					</td>
					<td class="time">
						0.38
					</td>
					<td class="actions">
							...
							<a class="remoteCall" href="/__debug__/sql_select/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.38&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Sel</a>
							<a class="remoteCall" href="/__debug__/sql_explain/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.38&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Expl</a>
							
						
					
					</td>
				</tr>
				<tr class="djUnselected djDebugHoverable djDebugEven djToggleDetails_28" id="sqlDetails_28">
					<td colspan="2"></td>
					<td colspan="4">
						<div class="djSQLDetailsDiv">
							<p><strong>Connection:</strong> default</p>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugOdd" id="sqlMain_29">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="29" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:72.918389%;"><strong style="width:7.413868%;">2.0077949687%</strong></div></div>
					</td>
					<td class="time">
						0.34
					</td>
				...
				<tr class="djUnselected djDebugHoverable djDebugOdd djToggleDetails_29" id="sqlDetails_29">
					<td colspan="2"></td>
					<td colspan="4">
						<div class="djSQLDetailsDiv">
							<p><strong>Connection:</strong> default</p>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugEven" id="sqlMain_30">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="30" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:74.926184%;"><strong style="width:9.703250%;">2.43297507972%</strong></div></div>
					</td>
					<td class="time">
						0.41
					</td>
				...
				<tr class="djUnselected djDebugHoverable djDebugEven djToggleDetails_30" id="sqlDetails_30">
					<td colspan="2"></td>
					<td colspan="4">
						<div class="djSQLDetailsDiv">
							<p><strong>Connection:</strong> default</p>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugOdd" id="sqlMain_31">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="31" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:77.359159%;"><strong style="width:10.432968%;">2.36211172788%</strong></div></div>
					</td>
					<td class="time">
						0.40
					</td>
				...
				<tr class="djUnselected djDebugHoverable djDebugOdd djToggleDetails_31" id="sqlDetails_31">
					<td colspan="2"></td>
					<td colspan="4">
						<div class="djSQLDetailsDiv">
							<p><strong>Connection:</strong> default</p>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugEven" id="sqlMain_32">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="32" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:79.721270%;"><strong style="width:14.298194%;">2.89949214598%</strong></div></div>
					</td>
					<td class="time">
						0.49
					</td>
					<td class="actions">
							...
							<a class="remoteCall" href="/__debug__/sql_select/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.49&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Sel</a>
							<a class="remoteCall" href="/__debug__/sql_explain/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.49&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Expl</a>
							
						
					
					</td>
				</tr>
				<tr class="djUnselected djDebugHoverable djDebugEven djToggleDetails_32" id="sqlDetails_32">
					<td colspan="2"></td>
					<td colspan="4">
						<div class="djSQLDetailsDiv">
							<p><strong>Connection:</strong> default</p>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugOdd" id="sqlMain_33">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="33" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:82.620762%;"><strong style="width:12.911994%;">2.24400614149%</strong></div></div>
					</td>
					<td class="time">
						0.38
					</td>
				...
				<tr class="djUnselected djDebugHoverable djDebugOdd djToggleDetails_33" id="sqlDetails_33">
					<td colspan="2"></td>
					<td colspan="4">
						<div class="djSQLDetailsDiv">
							<p><strong>Connection:</strong> default</p>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugEven" id="sqlMain_34">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="34" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:84.864769%;"><strong style="width:14.748341%;">2.23219558285%</strong></div></div>
					</td>
					<td class="time">
						0.38
					</td>
				...
				<tr class="djUnselected djDebugHoverable djDebugEven djToggleDetails_34" id="sqlDetails_34">
					<td colspan="2"></td>
					<td colspan="4">
						<div class="djSQLDetailsDiv">
							<p><strong>Connection:</strong> default</p>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugOdd" id="sqlMain_35">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="35" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:87.096964%;"><strong style="width:15.606407%;">2.01370024802%</strong></div></div>
					</td>
					<td class="time">
						0.34
					</td>
				...
				<tr class="djUnselected djDebugHoverable djDebugOdd djToggleDetails_35" id="sqlDetails_35">
					<td colspan="2"></td>
					<td colspan="4">
						<div class="djSQLDetailsDiv">
							<p><strong>Connection:</strong> default</p>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugEven" id="sqlMain_36">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="36" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:89.110664%;"><strong style="width:23.318872%;">2.53927010748%</strong></div></div>
					</td>
					<td class="time">
						0.43
					</td>
				...
				<tr class="djUnselected djDebugHoverable djDebugEven djToggleDetails_36" id="sqlDetails_36">
					<td colspan="2"></td>
					<td colspan="4">
						<div class="djSQLDetailsDiv">
							<p><strong>Connection:</strong> default</p>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugOdd" id="sqlMain_37">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="37" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:91.649935%;"><strong style="width:27.722772%;">2.31486949333%</strong></div></div>
					</td>
					<td class="time">
						0.39
					</td>
				...
				<tr class="djUnselected djDebugHoverable djDebugOdd djToggleDetails_37" id="sqlDetails_37">
					<td colspan="2"></td>
					<td colspan="4">
						<div class="djSQLDetailsDiv">
							<p><strong>Connection:</strong> default</p>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugEven" id="sqlMain_38">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="38" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:93.964804%;"><strong style="width:32.289628%;">1.9487421755%</strong></div></div>
					</td>
					<td class="time">
						0.33
					</td>
					<td class="actions">
							...
							<a class="remoteCall" href="/__debug__/sql_select/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.33&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Sel</a>
							<a class="remoteCall" href="/__debug__/sql_explain/?sql=SELECT%20%60auth_user%60.%60id%60%2C%20%60auth_user%60.%60username%60%2C%20%60auth_user%60.%60first_name%60%2C%20%60auth_user%60.%60last_name%60%2C%20%60auth_user%60.%60email%60%2C%20%60auth_user%60.%60password%60%2C%20%60auth_user%60.%60is_staff%60%2C%20%60auth_user%60.%60is_active%60%2C%20%60auth_user%60.%60is_superuser%60%2C%20%60auth_user%60.%60last_login%60%2C%20%60auth_user%60.%60date_joined%60%20FROM%20%60auth_user%60%20WHERE%20%60auth_user%60.%60id%60%20%3D%20%25s%20&amp;params=%5B4%5D&amp;duration=0.33&amp;hash=88aa8e6153eec3178d361c5fa71e8945aa3a08e2&amp;alias=default">Expl</a>
							
						
					
					</td>
				</tr>
				<tr class="djUnselected djDebugHoverable djDebugEven djToggleDetails_38" id="sqlDetails_38">
					<td colspan="2"></td>
					<td colspan="4">
						<div class="djSQLDetailsDiv">
							<p><strong>Connection:</strong> default</p>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugOdd" id="sqlMain_39">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="39" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:95.913546%;"><strong style="width:51.878612%;">2.11999527578%</strong></div></div>
					</td>
					<td class="time">
						0.36
					</td>
				...
				<tr class="djUnselected djDebugHoverable djDebugOdd djToggleDetails_39" id="sqlDetails_39">
					<td colspan="2"></td>
					<td colspan="4">
						<div class="djSQLDetailsDiv">
							<p><strong>Connection:</strong> default</p>
...
<span class="path">/edx/app/edxapp/edx-platform/common/djangoapps/student/</span><span class="file">models.py</span> in <span class="func">_key</span>(<span class="lineno">1061</span>)
  <span class="code">return (self.role, self.org, self.course_id, self.user)</span></pre>
				...
				<tr class="djDebugHoverable djDebugEven" id="sqlMain_40">
					<td class="color"><span style="background-color: rgb(256, 0, 0);">&nbsp;</span></td>
					<td class="toggle">
						<a class="djToggleSwitch" data-toggle-id="40" data-toggle-open="+" data-toggle-close="-" href="javascript:void(0)">+</a>
					</td>
					<td class="query">
						<div class="djDebugSqlWrap">
							<div class="djDebugSql"><strong>SELECT</strong> <a class="djDebugUncollapsed djDebugToggle" href="#">•••</a> <a class="djDebugCollapsed djDebugToggle" href="#">`auth_user`.`id`, `auth_user`.`username`, `auth_user`.`first_name`, `auth_user`.`last_name`, `auth_user`.`email`, `auth_user`.`password`, `auth_user`.`is_staff`, `auth_user`.`is_active`, `auth_user`.`is_superuser`, `auth_user`.`last_login`, `auth_user`.`date_joined`</a> <strong>FROM</strong> `auth_user` <strong>WHERE</strong> `auth_user`.`id` = 4</div>
					...
					<td class="timeline">
						<div class="djDebugTimeline"><div class="djDebugLineChart" style="left:98.033541%;"><strong style="width:100.000000%;">1.96645801346%</strong></div></div>
					</td>
					<td class="time">
						0.33
					</td>
				...
				<tr class="djUnselected djDebugHoverable djDebugEven djToggleDetails_40" id="sqlDetails_40">
					<td colspan="2"></td>
					<td colspan="4">
						<div class="djSQLDetailsDiv">
							<p><strong>Connection:</strong> default</p>
...
<table>
	...
	<tbody>
			...
			<tr class="djDebugOdd">
				...
				<td>class</td>
				<td>setup_join_cache, ensure_default_manager, do_pending_lookups, StatusField.prepare_class, add_status_query_managers, add_timeframed_query_manager, StatusField.prepare_class, StatusField.prepare_class, StatusField.prepare_class</td>
			</tr>
			...
			<tr class="djDebugOdd">
				...
				<td>request</td>
				<td>_rollback_on_exception, record_request_exception</td>
			</tr>
		
			<tr class="djDebugEven">
				<td>post_delete</td>
				<td>instance, using</td>
				<td>post_delete_metrics, clear_cache</td>
			</tr>
		
			<tr class="djDebugOdd">
				<td>post_init</td>
				<td>instance</td>
				<td>post_init_metrics, post_init_callback, MonitorField._save_initial, MonitorField._save_initial, MonitorField._save_initial, MonitorField._save_initial</td>
			</tr>
		
			<tr class="djDebugEven">
				<td>post_save</td>
				<td>instance, created, using, raw</td>
				<td>post_save_metrics, post_save_callback, assign_default_role_on_enrollment, update_score_summary, clear_cache, save_history, user_signup_handler</td>
			</tr>
		
			<tr class="djDebugOdd">
				<td>post_syncdb</td>
				<td>app, verbosity, interactive, class, created_models</td>
				<td></td>
			</tr>
			...
			<tr class="djDebugOdd">
				...
				<td></td>
				<td>close_connection, MemcachedCache.close, MemcachedCache.close, MemcachedCache.close, MemcachedCache.close, MemcachedCache.close, MemcachedCache.close, MemcachedCache.close, MemcachedCache.close, MemcachedCache.close</td>
			</tr>
