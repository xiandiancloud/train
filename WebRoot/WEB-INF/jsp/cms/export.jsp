  ...
  <section class="content">
    <article class="content-primary" role="main">
      ...
      <div class="introduction">
        ...
        <div class="copy">
          <p>您可以导出课程并在Studio之外编辑它们。导出的文件是.tar.gz类型的文件 (使用GNU Zip压缩格式的.tar文件)，包含课程结构和内容。您也可以再次导入这些导出的课程。</p>
        </div>
      </div>
    ...
    <aside class="content-supplementary" role="complimentary">
      <div class="bit">
        ...
        <p>您或许想在Studio之外直接编辑课程的XML，或想为您的课程建立备份，或想复制一份课程供日后导入进另一个课程实例和修改。</p>
      </div>
...
<table>
	...
	<tbody>
			...
			<tr class="djDebugOdd">
				...
				<td>30 voluntary, 10 involuntary</td>
			</tr>
...
<table>
	...
	<tbody>
			...
			<tr class="djDebugOdd">
				<td>HTTP_REFERER</td>
				<td>http://192.168.1.112:8001/import/cetc/CS201/2014_T1</td>
			</tr>
...
<table>
	...
	<tbody>
		<tr>
			<td>contentstore.views.import_export.export_handler</td>
			<td>None</td>
			<td>
