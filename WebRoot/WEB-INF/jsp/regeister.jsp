			...
			<div class="col-sm-8">
				<form role="form">
					<div class="form-group">
						<a>电子邮件&nbsp;*</a>
						<div class="h5"></div>
						<input type="text" class="form-control" id="mail" placeholder="文本输入">
						<div class="clear"></div>
						<a>密 码&nbsp;*</a>
						<div class="h5"></div>
						...
						<div class="clear"></div>
						<div class="clear"></div>
						<button type="button" class="btn btn-primary btn-lg btn-block" onclick="regeister();">
							注册我的  Your Platform Name Here账户</button>
					</div>
				</form>
			</div>
			<div class="col-sm-4">
